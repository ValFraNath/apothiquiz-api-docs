define({
    api: [
            ...
            permission: [
                {
                    ...
                    description:
                        "<p>The user has to be logged in to use this endpoint (see Authentication)</p>",
                },
            ],
            parameter: {
                fields: {
                ...
                fields: {
                    "Success 200": [
                        ...
                        },
                        {
                            ...
                            description:
                                "<p>The question subject - <em>if the round is the current one, or finished</em></p>",
                        },
                        {
                            group: "Success 200",
                            type: "string",
                            ...
                            description:
                                "<p>The wording of the question - <em>if the round is the current one, or finished</em></p>",
                        },
                        {
                            group: "Success 200",
                            type: "string[]",
                            ...
                            description:
                                "<p>The list of answers - <em>if the round is the current one, or finished</em></p>",
                        },
                        {
                            group: "Success 200",
                            type: "number",
                            ...
                            description:
                                "<p>Index of the good answer - <em>if the round is played by the user</em></p>",
                        },
                        {
                            group: "Success 200",
                            type: "number",
                            ...
                            description:
                                "<p>Index of the user answer - <em>if the round is played by the user</em></p>",
                        },
                        {
                            group: "Success 200",
                            type: "number",
                            ...
                            description:
                                "<p>Index of the opponent's answer - <em>if the round is played by the user &amp; the opponent</em></p>",
                        },
                    ],
                },
                examples: [
        ...
        },
        {
            ...
            version: "0.0.0",
            filename: "../glowing-octo-guacamole/server/controllers/usersImportation.js",
            groupTitle: "Import",
        },
        {
            type: "post",
            ...
            description:
                "<p>Import images to bind them to molecules; the format of the request must be multipart/form-data!</p>",
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: "confirmed",
                            description:
                                "<p>If &quot;true&quot;, the images will be imported, otherwise they will be only tested</p>",
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                "<p>Import a csv file to update the molecules data; the format of the request must be multipart/form-data!</p>",
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: "confirmed",
                            description:
                                "<p>If &quot;true&quot;, the data will be imported, otherwise they will be only tested</p>",
                        },
                    ],
                },
            },
        ...
        },
        {
            ...
            description:
                "<p>Import a csv file to update the users list; the format of the request must be multipart/form-data!</p>",
            parameter: {
                fields: {
                    Parameter: [
                        {
                        ...
                        },
                        {
                            ...
                            field: "confirmed",
                            description:
                                "<p>If &quot;true&quot;, the users will be imported, otherwise they will be only tested</p>",
                        },
                    ],
                },
            },
